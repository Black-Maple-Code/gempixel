...
- [x] **ERR-01**: When a save, download, or checkout action fails, the user sees a clear message instead of a silent no-op (extends the match-error surface to the remaining paths). (review W4, W5)
